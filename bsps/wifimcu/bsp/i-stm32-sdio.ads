...
package Interfaces.STM32.SDIO is
   ...
   type SDIO_Peripheral is record
      ...
      --  argument register
      ARG     : Interfaces.STM32.UInt32;
      --  command register
      CMD     : CMD_Register;
      --  command response register
      RESPCMD : RESPCMD_Register;
      --  response 1..4 register
      RESP1   : Interfaces.STM32.UInt32;
      --  response 1..4 register
      RESP2   : Interfaces.STM32.UInt32;
      --  response 1..4 register
      RESP3   : Interfaces.STM32.UInt32;
      --  response 1..4 register
      RESP4   : Interfaces.STM32.UInt32;
      --  data timer register
      DTIMER  : Interfaces.STM32.UInt32;
      --  data length register
      DLEN    : DLEN_Register;
      --  data control register
