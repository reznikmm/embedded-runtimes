...
package Interfaces.STM32.RTC is
   ...
   subtype CALR_CALW_Element is Interfaces.STM32.Bit;
   ...
   type RTC_Peripheral is record
      ...
      --  backup register
      BKP0R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP1R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP2R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP3R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP4R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP5R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP6R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP7R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP8R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP9R    : Interfaces.STM32.UInt32;
      --  backup register
      BKP10R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP11R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP12R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP13R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP14R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP15R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP16R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP17R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP18R   : Interfaces.STM32.UInt32;
      --  backup register
      BKP19R   : Interfaces.STM32.UInt32;
   end record
     with Volatile;
