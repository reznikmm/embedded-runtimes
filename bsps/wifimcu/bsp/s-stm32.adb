...
package body System.STM32 is
   ...
   begin
      case Source is
         ...
         when SYSCLK_SRC_PLL =>
            declare
               Pllm   : constant Word := Word (RCC_Periph.PLLCFGR.PLLM.Val);
               Plln   : constant Word := Word (RCC_Periph.PLLCFGR.PLLN.Val);
               Pllp   : constant Word := Word (RCC_Periph.PLLCFGR.PLLP.Val);
               Pllvco : Word;
