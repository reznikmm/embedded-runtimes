...
package Interfaces.STM32.NVIC is
   ...
   type NVIC_Peripheral is record
      ...
      ISER0 : Interfaces.STM32.UInt32;
      --  Interrupt Set-Enable Register
      ISER1 : Interfaces.STM32.UInt32;
      --  Interrupt Set-Enable Register
      ISER2 : Interfaces.STM32.UInt32;
      --  Interrupt Clear-Enable Register
      ICER0 : Interfaces.STM32.UInt32;
      --  Interrupt Clear-Enable Register
      ICER1 : Interfaces.STM32.UInt32;
      --  Interrupt Clear-Enable Register
      ICER2 : Interfaces.STM32.UInt32;
      --  Interrupt Set-Pending Register
      ISPR0 : Interfaces.STM32.UInt32;
      --  Interrupt Set-Pending Register
      ISPR1 : Interfaces.STM32.UInt32;
      --  Interrupt Set-Pending Register
      ISPR2 : Interfaces.STM32.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR0 : Interfaces.STM32.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR1 : Interfaces.STM32.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR2 : Interfaces.STM32.UInt32;
      --  Interrupt Active Bit Register
      IABR0 : Interfaces.STM32.UInt32;
      --  Interrupt Active Bit Register
      IABR1 : Interfaces.STM32.UInt32;
      --  Interrupt Active Bit Register
      IABR2 : Interfaces.STM32.UInt32;
      --  Interrupt Priority Register
      IPR0  : IPR_Register;
      --  Interrupt Priority Register
      IPR1  : IPR_Register;
